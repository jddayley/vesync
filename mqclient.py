...
class VesyncMQ:
    def connect(self, id, qname):
        client = mqtt.Client(
            "Humidifier_%s" % randint(1000, 9999)
    ...
    def main(self):
        client = VesyncMQ()
        client.connect('vsaq7588f6f84290868639af8c171175',
                       "home/humidifier/state/basement")
        client.connect('vsaq7de16d3b4db2bae840277b436b61',
                       "home/humidifier/state/upstairs")
